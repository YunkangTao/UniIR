...
UNIIR_DIR="/home/chenyang_lei/video_diffusion_models/UniIR/UniIR/" # <--- Change this to the UniIR directory
MBEIR_DATA_DIR="/home/chenyang_lei/video_diffusion_models/UniIR/M-BEIR/" # <--- Change this to the MBEIR data directory you download from HF page
